...
export const FRAMEWORK_CSS_CONFIG: readonly FrameworkCssConfig[] = [
  {
    framework: 'generic',
    cssImport: 'mdx-tools/components/styles/generic.css',
    allowRetry: true,
  },
  {
    framework: 'docusaurus',
    cssImport: 'mdx-tools/components/styles/docusaurus.css',
    allowRetry: true,
  },
  {
    framework: 'starlight',
    cssImport: 'mdx-tools/components/styles/starlight.css',
    allowRetry: true,
  },
  {
    framework: 'nextra',
    cssImport: 'mdx-tools/components/styles/nextra.css',
    allowRetry: true,
  },
  {
    framework: 'nextjs',
