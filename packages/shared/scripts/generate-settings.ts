// packages/shared/scripts/generate-settings.ts
// sync package.json setting defaults & enums from shared config sources
...
function main(): void {
  console.log('Syncing package.json settings from shared config...');
