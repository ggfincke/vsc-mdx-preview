// packages/contracts/src/preview/scroll-sync.ts
// shared source-line scroll sync tuning constants

// keep source lines near the top-third reading band to match MPE feel
