// packages/registry/src/icons/index.ts
// centralized SVG icon definitions for callouts & alerts
// shared between extension (remark plugins) & webview (React components)
...
export const GITHUB_ICONS = {
  ...
  // arrow for cards
  arrowRight:
    '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path fill-rule="evenodd" d="M8.22 2.97a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06-1.06l2.97-2.97H3.75a.75.75 0 0 1 0-1.5h7.44L8.22 4.03a.75.75 0 0 1 0-1.06Z"></path></svg>',
...
// uppercase key versions for extension remark plugins (GitHub blockquote alerts)
...
// generic Lucide icons used by webview JSX icon components
...
// type exports
export type CalloutIconType = keyof typeof CALLOUT_ICONS;
export type GitHubIconType = keyof typeof GITHUB_ICONS;
export type GitHubAlertIconType = keyof typeof GITHUB_ALERT_ICONS;
export type FileTreeIconType = keyof typeof FILE_TREE_ICONS;
