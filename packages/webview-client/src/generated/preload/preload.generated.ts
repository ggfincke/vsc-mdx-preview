...
import generic_Callout from '../../features/shims/generic/Callout';
import generic_Collapsible from '../../features/shims/generic/Collapsible';
import generic_Tabs from '../../features/shims/generic/Tabs';
import generic_TabItem from '../../features/shims/generic/TabItem';
import generic_CodeGroup from '../../features/shims/generic/CodeGroup';
...
> = {
  Callout: async (registry: ModuleRegistry) => {
    const component = await import('../../features/shims/generic/Callout').then(
      (m) => m.default
    );
    registry.preload(
      'npm://@mdx-preview/shims-generic/Callout',
  ...
  Collapsible: async (registry: ModuleRegistry) => {
    const component =
      await import('../../features/shims/generic/Collapsible').then(
        (m) => m.default
      );
    registry.preload(
      'npm://@mdx-preview/shims-generic/Collapsible',
  ...
  Tabs: async (registry: ModuleRegistry) => {
    const component = await import('../../features/shims/generic/Tabs').then(
      (m) => m.default
    );
    registry.preload(
      'npm://@mdx-preview/shims-generic/Tabs',
  ...
  TabItem: async (registry: ModuleRegistry) => {
    const component = await import('../../features/shims/generic/TabItem').then(
      (m) => m.default
    );
    registry.preload(
      'npm://@mdx-preview/shims-generic/TabItem',
  ...
  CodeGroup: async (registry: ModuleRegistry) => {
    const component =
      await import('../../features/shims/generic/CodeGroup').then(
        (m) => m.default
      );
    registry.preload(
      'npm://@mdx-preview/shims-generic/CodeGroup',
...
export async function loadDocusaurusShims(
  ...
  const [
    ...
    import('../../features/shims/docusaurus/Tabs').then((m) => m.default),
    import('../../features/shims/docusaurus/Tabs').then((m) => m.TabItem),
    import('../../features/shims/docusaurus/CodeBlock').then((m) => m.default),
    import('../../features/shims/docusaurus/Details').then((m) => m.default),
  ]);
...
export async function loadStarlightShims(
  ...
  const [
    ...
    import('../../features/shims/starlight'),
    import('../../features/shims/starlight/Card').then((m) => m.default),
    import('../../features/shims/starlight/CardGrid').then((m) => m.default),
    import('../../features/shims/starlight/LinkCard').then((m) => m.default),
    import('../../features/shims/starlight/Steps').then((m) => m.default),
    import('../../features/shims/starlight/Badge').then((m) => m.default),
    import('../../features/shims/starlight/Aside').then((m) => m.default),
    import('../../features/shims/starlight/Tabs').then((m) => m.Tabs),
    import('../../features/shims/starlight/Tabs').then((m) => m.TabItem),
    import('../../features/shims/starlight/FileTree').then((m) => m.default),
    import('../../features/shims/starlight/Code').then((m) => m.default),
  ]);
...
export async function loadNextraShims(registry: ModuleRegistry): Promise<void> {
  const [
    ...
    import('../../features/shims/nextra'),
    import('../../features/shims/nextra/Callout').then((m) => m.default),
    import('../../features/shims/nextra/Tabs').then((m) => m.default),
    import('../../features/shims/nextra/Cards').then((m) => m.default),
    import('../../features/shims/nextra/FileTree').then((m) => m.default),
    import('../../features/shims/nextra/Steps').then((m) => m.default),
    import('../../features/shims/nextra/Bleed').then((m) => m.default),
  ]);
...
export async function loadNextjsShims(registry: ModuleRegistry): Promise<void> {
  const [nextjs_Image, nextjs_Link] = await Promise.all([
    import('../../features/shims/nextjs/Image').then((m) => m.default),
    import('../../features/shims/nextjs/Link').then((m) => m.default),
  ]);
