...
The YAML frontmatter at the top of this document is automatically parsed and displayed as a collapsible section. Click the "Frontmatter" header in the preview to see the metadata:
...
You can access frontmatter values in your content using the `frontmatter` object (Trusted Mode only):

**Document Title:** {typeof frontmatter !== 'undefined' ? frontmatter.title : 'MDX Preview Feature Showcase'}
