...
The project uses npm workspaces w/ six packages plus one external npm dependency:
...
```typescript title="mdx-forge: src/browser/preload/shimLoader.ts"
// Docusaurus shims
...
| `src/features/shims/`           | Framework component shim re-exports (from mdx-forge)     |
